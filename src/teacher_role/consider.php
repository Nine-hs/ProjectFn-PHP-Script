...
try {
    if ($_GET['form']) {
        $sql = "SELECT FORM_ID, ST_ID, ST_NUMBER, F_NAME, L_NAME, fc.ST_FACULTY as Faculty, m.ST_MAJOR as MAJOR, pg.ST_PROGRAM as PROGRAM," .
            " CONCAT(em.EM_NAME,' ',em.EM_LASTNAME) AD_CLASS, AD_ID, ST_GEN, ST_GRADE, DATE_, ST_AGE_, BRITH_YEAR, ST_NAT, ST_RACE, ST_RELIGION, ST_LOCAT," .
            " ST_HOME, ST_ALLAY, ST_STREET, sd1.SUBDIST_NAME as ST_SD, d1.DISTRICT_NAME as ST_D, pv1.PROVINCE_NAME as ST_PV, ST_TELL, ST_PHONE, FACEBOOK," .
            " FAMILY_STATUS, FULLNAME_FATHER, FATHER_CAREER, FATHER_INCOME, FATHER_PHONE, FULLNAME_MOTHER, MOTHER_CAREER, MOTHER_INCOME, MOTHER_PHONE," .
            " NUM_RELA, BEING_NUM, STAY_WITH, CURR_HOME, CURR_ALLAY, CURR_STREET, sd2.SUBDIST_NAME as ST_SD2, d2.DISTRICT_NAME as ST_D2," .
            " pv2.PROVINCE_NAME as ST_PV2, PATR_FULLNAME, PATR_CAREER, PATR_INCOME, RELAT, PATR_PHONE, SCH_BORROW, SCHOLAR, Job, PARTTIME_PLACE," .
            " P_DETAIL_CARR, P_TIME_PERIOD, P_INCOME, FULLTIME_PLACE, F_DETAIL_CARR, F_TIME_PERIOD, F_INCOME, ACTI_TIME_PERIOD, ACTI_HOURS, ACTI_DESCRIBE," .
            " ST_DESCRIPE FROM formtb f INNER JOIN facultytb fc ON f.ST_FACULTS = fc.facultytb INNER JOIN majors m ON f.ST_MAJORS=m.ID_MAJOR " .
            "INNER JOIN programtb pg ON f.ST_PROGRAMS=pg.ID_PROGRAM INNER JOIN employeetb em ON f.AD_ID=em.EM_ID INNER JOIN subdisttb sd1 ON f.ST_SUBDIST=sd1.SUBDIST_ID " .
            " INNER JOIN disttb d1 ON f.ST_DIST=d1.DISTRICT_ID INNER JOIN provincetb pv1 ON f.ST_PROVINCE=pv1.PROVINCE_ID INNER JOIN subdisttb sd2 ON f.CURR_SUBDIST=sd2.SUBDIST_ID" .
            " INNER JOIN disttb d2 ON f.CURR_DIST=d2.DISTRICT_ID INNER JOIN provincetb pv2 ON f.CURR_PROVINCE=pv2.PROVINCE_ID WHERE f.FORM_ID = :id";
...
?>
        ...
        <head>
            ...
            <link href="./css/consider.css" rel="stylesheet">
            <title>พิจารณาการให้ทุนประจำปี
            </title>
        </head>
                ...
                <main class="mdl-layout__content">
                    ...
                    <div class="card mt-3 card-box">
                        <div class="card-header">
                            แบบฟอร์มสมัครขอรับทุนการศึกษา ประจำปีการศึกษา พ.ศ. <span id="years"> </span>
                        </div>
                        <div class="card-body col-sm-12 col-md-12">
                            ...
                            <div class="container">
                                ...
                                <form action="sv/comment.php" method="post">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="mb-3">
                                                <label for="exampleFormControlTextarea1" class="form-label label">ข้าพเจ้า: <?php echo $i['AD_CLASS']; ?> <br> อาจารย์ที่ปรึกษาชั้น: <?php echo $i['ST_GEN']; ?></label>
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <input class="form-check-input" type="hidden" name="aivisor_id" value="<?php echo $i['AD_ID']; ?>">
                        ...
                        echo $e->getMessage();
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-primary save-btn"><i class="fa fa-floppy-o margin-r-5" aria-hidden="true"></i> บันทึก</button>
